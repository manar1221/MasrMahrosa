        ...
        <div class="cbox-container text-end vh-100" style="text-align: right;">
           <div class="card">
             <div class="card-header">
                <div class="row">
                   <div class="col-md-6">
                      <a href="{{route('araml.add')}}" class="cbtn float-start w-25 text-decoration-none"> إضافة حالة </a>
                  </div>
                ...
                <table class="table fw-bolder fs-3 table-bordered  table-responsive">
                   ...
                   <tbody>
                      ...
                      @foreach($araml_cases as $araml_case)
                        <tr>
                          <td>
                            <a href="{{route('araml.edit',['aramlcase_id'=>$araml_case->id])}}" class="text-info text-decoration-none"> تعديل </a> /
                            <a href="{{route('case.details',['case_id'=>$araml_case->case_id])}}" class="text-success text-decoration-none"> عرض </a> /
                            <a href="#" onclick="deleteConfirmation({{ $araml_case->id }})" class="text-danger text-decoration-none"> حذف </a>
                          </td>
